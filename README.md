...
* [`src/example/`](src/example/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/example/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `example` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/example/config.cljs) defaults to `true` in
